  ...
  return new Promise((resolve, reject) => {
    ...
    pool.getConnection((err, connection) => {
      if (err) {
        ...
        connection.query(userDataQuery, queryArray, (err, results) => {
          if (err) {
            reject(err);
          } else {
            console.log(
...
module.exports.getOneUserData = (recordId) => {
...
module.exports.getOneUserDataByEmail = (search) => {
...
module.exports.getOneDesignData = (recordId) => {
